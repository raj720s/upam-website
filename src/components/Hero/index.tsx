...
const Hero = () => {
  return (
    <>
      <section
        id="home"
        className="relative overflow-hidden pt-32 bg-primary dark:bg-gradient-to-tr from-dark to-dark-3 dark:via-dark-4"
      >
            ...
            <div className="w-full px-4">
              ...
              >
                <h1 className="mb-6 text-3xl font-bold leading-snug sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2] text-white">
                  Upam: Empowering Your Digital Future
                </h1>
                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium sm:text-lg sm:leading-[1.44] text-white">
                  Derived from the Sanskrit word for "best," Upam is dedicated to delivering best solutions for your business.
                </p>
                ...
                <div>
                  ...
                  <p className="mb-4 text-center text-base font-medium text-white/60">
                    We bring your brand to life online with cutting-edge technology, tailored marketing strategies, and a commitment to excellence.
                  </p>
                  <div
